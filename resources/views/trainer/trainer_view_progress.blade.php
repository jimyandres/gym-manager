...
@section('content')
	...
	<div class="center">
		<a href="{{ route('progress::newRecord', $id) }}" class="btn large waves-effect waves-light green darken-4 center " data-position="bottom" data-delay="50" data-tooltip="Progresos">
			Nuevo Registro
		</a>
	</div>
